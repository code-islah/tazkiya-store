  ...
  return (
    <div className="grid clr-bg-dark clr-text-lightSub">
      ...
      <div className="p-3">
        ...
        <div className="py-5">
          <h1 className="text-sky-400 text-lg text-bold my-3">
            আপনার মতামত জানান!
          </h1>
          <div className="grid gap-2 clr-text-dark">
            <input
              className="w-full px-3 p-1 rounded
        ...
        focus:outline focus:outline-2 focus:outline-sky-400"
            ...
            />
            <textarea
              className="w-full px-3 p-1 rounded focus:outline focus:outline-2 focus:outline-sky-400"
              type="text"
              placeholder="আপনার মতামতঃ"
            ></textarea>
            <div className="flex gap-1">
              <button className="bg-sky-400 text-white flex-1 p-1 rounded">
                পাঠান
              </button>
              <button className="bg-sky-400 text-white flex-1 p-1 rounded">
                মুছুন
