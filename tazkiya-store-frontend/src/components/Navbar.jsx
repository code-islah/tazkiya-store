      ...
      <div className="flex gap-5">
        <div className="flex gap-3">
          ...
          >
            ...
            {showFav && (
              <div className="animateTopToBottom absolute right-2 mt-3 w-[90%] text-center z-10 shadow-lg">
                <h1 className="text-left backdrop-blur-md rounded gap-5 bg-sky-100/50">
                  <span className="py-2 border rounded px-2 bg-sky-400 text-white text-sky-400">
                    You Loved :
                  </span>
                  {favItems.map((item) => {
                    ...
                    return (
                      <div className="mt-2" key={item}>
                        <div className="flex justify-between p-1 px-3 whitespace-nowrap overflow-hidden text-ellipsis">
                          <div>
                            <span>{item}</span> - &nbsp;
                            {product ? (
                              <span className="overflow-hidden text-ellipsis clr-text-dark font-bold">
                                {product.price + "৳"}
                              </span>
                            ) : (
                              "N/A"
                          ...
                          <div className="flex gap-1">
                            <button
                              ...
                              className="bg-sky-400 rounded px-3 py-[3px]"
                            >
                              <img
                                className="w-5 p-[1px]"
                                src="/SVGs/cartPlus.svg"
                                alt="cart"
                              />
                            </button>
                            <button
          ...
          >
            ...
            {showLocation && (
              <div className="animateTopToBottom absolute right-3 mt-2 w-[80%] z-50 shadow-lg">
                <span className="inline-block py-2 border rounded px-2 bg-sky-400 clr-text-light mt-[-10px]">
                  আমাদের ঠিকানাঃ
                </span>
                <h1 className="text-center backdrop-blur-md p-2 rounded bg-sky-100/50 gap-2">
                  আরাম পাড়া, চুয়াডাঙ্গা। <br /> মাছের আড়তের পাশে, গোরস্থান
                  মসজিদের সম্মুখে।
                </h1>
                <iframe
                  ...
                  className="w-full bg-black/50 rounded shadow-xl"
                  height="250"
                  style={{ border: 0 }}
                  allowFullScreen=""
                  loading="lazy"
          ...
          >
            <img className="w-6" src="/SVGs/cart.svg" />
          </div>

          {showCart && (
            <div className="backdrop-blur-md rounded bg-sky-100/50 animateTopToBottom absolute mt-10 w-[70%] right-3 z-50 shadow-lg">
              <div className="p-2">
                <h1 className="mb-4 border rounded p-2 bg-sky-400 clr-text-light inline-block absolute left-0 top-[-40px]">
                  নির্বাচিত পণ্যঃ
                </h1>
                ...
                {cartItems.length > 0 && (
                  <div className="grid">
                    <div className="grid gap-1">
                      ...
                      >
                        এগিয়ে যান <span className="text-sky-500">❯</span>
                      </button>
                    </div>
                  </div>
                )}
            ...
            <Fragment>
              ...
              >
                <div className="p-1 border rounded  bg-sky-400 text-white">
                  <span className="flex capitalize justify-between px-3">
                    {user.name} <img className="w-5" src="/SVGs/settings.svg" />
                  </span>{" "}
                </div>
